...
function Sidebar() {
  return <>
    <div className="h-px lg:w-px lg:h-auto bg-gray-300 mx-4"></div>
    <div className="w-80">
      <p>You&apos;re on a</p>
      <h3 className="text-lg font-bold">2 day streak </h3>
      <div className="h-0.5 flex items-center mt-8 justify-between text-white text-sm" style={{ background: gradient }}>
